                    ...
                    <form class="form" @submit.prevent="submitForm">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="title" placeholder="Name of Resource"
                                    v-model="form.name" @focus="clearError" />
        ...
        new Vue({
            ...
            methods: {
                submitForm() {
                    // console.log('working!!')
                    if (!this.form.name) {
                        this.errors.push('Name input cannot be empty')
                        // Swal.fire({
                        //     icon: 'error',
                        //     title: 'Oops...',
                    ...
                    if (!this.form.type) {
                        this.errors.push('You\'ve not selected an upload type')
