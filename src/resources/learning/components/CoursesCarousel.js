                                    ...
                                    <div class="card-body">
                                      ...
                                      <div><span class="checked rating-value">4.8 </span><span class="ratings fa fa-star checked"></span>
                                        ...
                                        <div class="mt-3 button-style">
                                            <a :href="'/learner/courses/'+item.title" style="background-color: #495057; color: white;" class="float-left btn-style btn btn-sm">View</a>
                                            <a :href="'/learner/courses/'+item.title+'/lesson/'+item.author" style="background-color: #495057; color: white;" class="float-right btn-style btn btn-sm">Take Course</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
